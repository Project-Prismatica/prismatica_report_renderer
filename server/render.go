...
func (s PrismaticaReportRendererServer) Render(ctx context.Context, r *prismatica_report_renderer.RenderRequest) (*prismatica_report_renderer.RenderResponse, error) {
	...
	logrus.WithFields(logrus.Fields{"fondTemplate": foundTemplate}).Debug("found template")
